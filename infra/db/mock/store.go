...
// Source: github.com/pe-Gomes/simple-bank-go/infra/db/repository (interfaces: Store)
//
...
func (m *MockStore) TransactionTx(arg0 context.Context, arg1 db.CreateTransactionParams) (db.TransactionTxResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) TransactionTx(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
