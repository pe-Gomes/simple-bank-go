...
func TestTransactionTx(t *testing.T) {
	...
	// run n concurrent transaction transaction
	for i := 0; i < n; i++ {
		go func() {
			result, err := testStore.TransactionTx(context.Background(), CreateTransactionParams{
...
func TestTransferTxDeadlock(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		go func() {
			_, err := testStore.TransactionTx(context.Background(), CreateTransactionParams{
